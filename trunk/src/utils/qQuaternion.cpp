...
void qQuaternion::CreateMatrix(float *pMatrix){
...
void qQuaternion::CreateFromMatrix(float *pTheMatrix, int rowColumnCount){
...
qQuaternion qQuaternion::Slerp(qQuaternion &q1, qQuaternion &q2, float t){
	...
	if(result < 0.0f)
	{
		...
		q2 = qQuaternion(-q2.x, -q2.y, -q2.z, -q2.w);
		result = -result;
	}
